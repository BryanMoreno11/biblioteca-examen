...
const { getEstudiante, getEstudiantes, createEstudiante, updateEstudiante, deleteEstudiante, updateFechaFinSancion } = require('../Controllers/estudianteController');
...
router.put('/estudiante/sancion/:id', updateFechaFinSancion); // Crear un nuevo estudiante
